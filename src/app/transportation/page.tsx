              ...
              {fleet.map((item, idx) => (
                <div key={idx} className="p-6 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-200 hover:bg-blue-50/50 transition-all group">
                  ...
                  <p className="text-slate-500 font-medium flex items-center gap-2">
                    <Users className="w-4 h-4" /> {t("capacity")}: {item.capacity}
                  </p>
                </div>
              ))}
            </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-800 border-b border-slate-700">
                  <th className="px-8 py-6 text-lg font-bold">{t("groupSize")}</th>
                  <th className="px-8 py-6 text-lg font-bold text-blue-400">{t("pricePerPerson")}</th>
                </tr>
              </thead>
                    ...
                    <td className="px-8 py-8">
                      <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-500 text-[10px] font-bold uppercase tracking-widest bg-slate-700/50 px-2 py-1 rounded">{t("perPax")}</span>
                        </div>
                        <div className="flex items-center gap-4 text-slate-400 font-medium">
                          <span className="flex items-center gap-1.5 min-w-[70px]">
                            ...
                            <span className="text-base tabular-nums">&euro;{tier.eur}</span>
                          </span>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex flex-col items-center">
                <p className="text-slate-400 mb-6">{t("customQuote")}</p>
                <a
      ...
      <section className="py-24 container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center p-8">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-4">{t("benefit1Title")}</h3>
            ...
            <div className="text-center p-8">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-4">{t("benefit2Title")}</h3>
            ...
            <div className="text-center p-8">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-4">{t("benefit3Title")}</h3>
